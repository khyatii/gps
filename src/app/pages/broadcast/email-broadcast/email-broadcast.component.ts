...
@Component({
  ...
  styleUrls: ['./email-broadcast.component.css']
})
export class EmailBroadcastComponent implements OnInit {
  ...
  submit(formValues) {
    ...
    this.othersService.emailBroadcast(formValues).subscribe(res => {
